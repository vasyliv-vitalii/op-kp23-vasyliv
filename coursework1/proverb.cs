...
namespace cursova
{
    class proverb : abstractclass
    {
        ...
        public string Proverb { get => proverbs; }
        public string Source { get => source; }
        public string Topics { get => topics; }
        public string Keyword { get => keywords; }
        public List<proverb> ListOfSaying = new List<proverb>();
        public proverb(string author, string proverb, string source, string type, string topics, string keywords)
        {
            this.author = author;
        ...
        {
            string path = "D:\\123232323\\cursova\\cursova\\proverb.csv";
