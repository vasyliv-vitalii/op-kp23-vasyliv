...
namespace cursova
{
    internal class sarcasm : abstractclass
    {
        private string author;
        private string source;
        private string topics;
        private string keywords;
        private string sarcasms;
        private string type;
        public string Type { get => type; }
        public string Author { get => author; }
        public string Sarcasms { get => sarcasms; }
        public string Source { get => source; }
        public string Topics { get => topics; }
        public string Keyword { get => keywords; }
        public List<sayings> ListOfSaying = new List<sayings>();
        public sarcasm(string author, string sarcasms, string source, string type, string topics, string keywords)
        {
            this.author = author;
        ...
        {
            string path = "D:\\123232323\\cursova\\cursova\\sarcasm.csv";
            ...
            sr.Close();
            string[] arrayofsarcasm = new string[lenght];
            StreamReader sr1 = new StreamReader(path);
            for (int i = 0; i < arrayofsarcasm.Length; i++)
            {
                arrayofsarcasm[i] = sr1.ReadLine();
            }
            sr1.Close();
            return arrayofsarcasm;
        }
